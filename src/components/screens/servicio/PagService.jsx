...
import SwiperExamples from "./SwiperExamples";
...
function PagService({dataService}) {
  return (
    <div className={`${dataService.general.backgroundPage} container-fluid`}>
                  ...
                  <div className="bg-dark bg-gradiente shadow rounded-20 p-4 bg-opacity-75">
                    ...
                    {dataPackage.include != null ? (
                      <>
                        ...
                        >
                          {dataPackage.include.map((itemIncluded, index) => {
